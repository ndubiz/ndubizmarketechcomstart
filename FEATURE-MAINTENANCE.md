...
Prices and numerical ratings are withheld until verified and visibly published with provenance. Never copy off-site aggregate reviews into your own AggregateRating markup. Product + Article JSON-LD identifies current pages but does not qualify them automatically for Google Product rich results: eligibility additionally needs supported Offer or qualifying review/rating evidence. Do not invent that evidence to silence a validator.
